...
meta_collection_file = Path(Path.cwd() / "data" / "judikatur" / "justiz" / "justiz_meta_collection_all_2023.xml")
...
# save links to file
year = "2023"
links_file = Path(Path.cwd() / "data" / "judikatur" / "justiz" / f"justiz_all_decision_links_{year}.links")
