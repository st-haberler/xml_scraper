...
meta_collection_file = Path(Path.cwd() / "data" / "judikatur" / "vwgh" / "vwgh_meta_collection_all_2023.xml")
...
# save links to file
year = "2023"
links_file = Path(Path.cwd() / "data" / "judikatur" / "vwgh" / f"vwgh_all_decision_links_{year}.links")
